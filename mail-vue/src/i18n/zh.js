const zh = {
    ...
    pushNotifyTitle: '邮件推送通知',
    pushNotifyDesc: '配置你自己的推送渠道，收到新邮件时推送到你的设备（仅推送发给你邮箱的邮件）',
    pushChannel: '推送渠道',
    pushChannelWebhook: '自定义 Webhook',
    pushBarkPlaceholder: 'Bark Key 或自建完整地址，如 https://api.day.app/xxxx',
    pushServerchanPlaceholder: 'Server酱 SendKey，在 sct.ftqq.com 获取',
    pushWebhookPlaceholder: '接收 JSON 通知的完整 URL',
    pushTest: '测试',
    pushDelete: '解除配置',
    pushConfigured: '当前配置',
    ...
    userPush: '用户推送',
    userPushDesc: '开启后，用户可在「个人设置」中配置自己的推送渠道（Bark、Server酱、自定义 Webhook），仅接收发送到自己邮箱的邮件通知，关闭后立即对所有用户失效',
