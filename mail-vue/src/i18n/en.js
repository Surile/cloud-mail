const en = {
    ...
    pushNotifyTitle: 'Email Push Notification',
    pushNotifyDesc: 'Set up your own push channel to get notified on your device when new emails arrive (only emails addressed to you)',
    pushChannel: 'Channel',
    pushChannelWebhook: 'Custom Webhook',
    pushBarkPlaceholder: 'Bark key or full self-hosted URL, e.g. https://api.day.app/xxxx',
    pushServerchanPlaceholder: 'ServerChan SendKey, get it at sct.ftqq.com',
    pushWebhookPlaceholder: 'Full URL that receives JSON notifications',
    pushTest: 'Test',
    pushDelete: 'Remove',
    ...
    userPush: 'User Push',
    userPushDesc: 'When enabled, users can configure their own push channels (Bark, ServerChan, custom Webhook) in personal settings and only receive notifications for their own emails. Disabling takes effect for all users immediately',
