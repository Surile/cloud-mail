const en = {
	...
	oauthUnbindLastDenied: 'Keep at least one login method: the last third-party identity cannot be unbound',
	...
	pushInvalidChannel: 'Invalid push channel',
	pushMissingConfig: 'Push configuration is required',
	pushInvalidFormat: 'Invalid credential format',
	pushInvalidUrl: 'Invalid or disallowed push URL',
	pushDisabled: 'Push feature is disabled by admin',
	pushNotConfigured: 'Save your push configuration first',
	pushSendFail: 'Push failed',
	pushTestTitle: 'Test Push',
	pushTestBody: 'Configured. New emails will be pushed here.',
	pushVerifyCode: 'Code',
	pushNoSubject: 'No subject',
	...
	applyExists: 'You already have a pending application',
	applyNotFound: 'Application not found',
	applyProcessed: 'This application has already been processed',
	oauthBound: 'This account is already bound to an email, please sign in directly',
	...
	perms: {
		...
		"密钥删除": "Delete Code",
		"申请管理": "Applications",
		"申请查看": "View Applications",
		"申请审核": "Review Applications",
