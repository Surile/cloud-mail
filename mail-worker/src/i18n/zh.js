const zh = {
	...
	oauthUnbindLastDenied: '至少保留一种登录方式，不能解绑最后一个第三方身份',
	...
	pushInvalidChannel: '推送渠道无效',
	pushMissingConfig: '推送配置不能为空',
	pushInvalidFormat: '凭证格式不正确',
	pushInvalidUrl: '推送地址不合法或不允许访问',
	pushDisabled: '管理员未开启推送功能',
	pushNotConfigured: '请先保存推送配置',
	pushSendFail: '推送失败',
	pushTestTitle: '测试推送',
	pushTestBody: '配置成功，收到新邮件时会推送到这里',
	pushVerifyCode: '验证码',
	pushNoSubject: '无主题',
	pwdMinLength: '密码至少六位',
	...
	applyExists: '已有待审核的申请单',
	applyNotFound: '申请单不存在',
	applyProcessed: '该申请已被处理',
	oauthBound: '该账号已绑定邮箱，请直接登录',
